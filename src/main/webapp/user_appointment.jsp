	...
	<div class="container p-3">
		<div class="row">
			<div class="col-md-6 p-5">
				<img alt="" src="img/Doctor3.jpg" height="75%" width="75%">
					...
					<div class="card-body">
						...
						<form class="row g-3" action="appAppointment" method="post">
							...
							<c:if test="${empty userObj }">
								<!-- Agar user user login nahi hoga to aage nahi jayega user login page pe jayega
								 -->
